...
class TestResourceClass(unittest.TestCase):
    ...
    def test_updating(self):
        ...
        r2 = ResourceClass.read(con=self._connection,
                                ...
                                owl_class_iri=QName("test:testMyRes"))
        print("\n+++++++++===================")
        gaga = LangString(["My Resource@en", "Meine Ressource@de", "Ma Resource@fr", "La mia risorsa@it"])
        print(type(r2.get(ResourceClassAttribute.LABEL)))
        print(r2.get(ResourceClassAttribute.LABEL))
        print(type(gaga))
        print(gaga)
        print(":::::>", r2.get(ResourceClassAttribute.LABEL) == gaga)
        self.assertTrue(r2.get(ResourceClassAttribute.LABEL) == LangString(["My Resource@en", "Meine Ressource@de", "Ma Resource@fr", "La mia risorsa@it"]))
        ...
        print("\n+++++++++===================")
        gaga = LangString(["A text", "Ein Text@de", "Un Texte Français@fr"])
        print(type(r2[QName('test:hasText')][PropertyClassAttribute.NAME]))
        print(r2[QName('test:hasText')][PropertyClassAttribute.NAME])
        print(type(gaga))
        print(gaga)
        print(":::::>", r2.get(ResourceClassAttribute.LABEL) == gaga)
        self.assertTrue(r2[QName('test:hasText')][PropertyClassAttribute.NAME] == LangString(["A text", "Ein Text@de", "Un Texte Français@fr"]))
