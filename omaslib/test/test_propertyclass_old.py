...
from omaslib.src.propertyclass import PropertyClass, OwlPropertyType, PropClassAttrContainer, PropClassAttrChange
...
class TestPropertyClass(unittest.TestCase):
    ...
    def test_propertyclass_constructor(self):
        ...
        self.assertEqual(p.get(PropClassAttr.SUBPROPERTY_OF), Xsd_QName('test:comment'))
        ...
        self.assertEqual(p.get(PropClassAttr.ORDER), 5)
        ...
        self.assertEqual(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.MAX_COUNT), 1)
        ...
        self.assertEqual(p3[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.IN), {'yes', 'may be', 'no'})
    ...
    def test_propertyclass_read_shacl(self):
        ...
        self.assertEqual(p1.get(PropClassAttr.RESTRICTIONS)[PropertyRestrictionType.MAX_COUNT], 1)
        ...
        self.assertEqual(p1[PropClassAttr.ORDER], 2)
        ...
        self.assertEqual(p2[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.MIN_COUNT], 1)
        ...
        self.assertEqual(p2[PropClassAttr.ORDER], 3)
    ...
    def test_propertyclass_create(self):
        props: PropClassAttrContainer = {
            ...
            PropClassAttr.NAME: LangString("Annotations@en"),
        ...
        self.assertEqual(p2[PropClassAttr.ORDER], 11)
    ...
    def test_propertyclass_undo(self):
        ...
        self.assertEqual(p1[PropClassAttr.DATATYPE], XsdDatatypes.anyURI)
        ...
        self.assertEqual(p1[PropClassAttr.ORDER], 11)

        p1[PropClassAttr.TO_NODE_IRI] = Xsd_QName('test:waseliwas')
        ...
        p1[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.LANGUAGE_IN] = {Language.EN, Language.DE, Language.FR}
        p1[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.IN] = {"http://google.com", "https//google.com"}
        p1[PropClassAttr.ORDER] = 22

        self.assertEqual(p1[PropClassAttr.TO_NODE_IRI], Xsd_QName('test:waseliwas'))
        self.assertEqual(p1[PropClassAttr.DATATYPE], XsdDatatypes.anyURI)
        ...
        self.assertEqual(p1[PropClassAttr.ORDER], 22)
        ...
        p1[PropClassAttr.DESCRIPTION] = LangString("A description@en")
        p1[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.LANGUAGE_IN] = {Language.EN, Language.DE, Language.FR}
        p1[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.IN] = {
    ...
    def test_propertyclass_update(self):
        ...
        p1[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.IN] = {"gaga", "is was"}
        p1[PropClassAttr.DATATYPE] = XsdDatatypes.string
        self.assertEqual(p1.changeset, {
            PropClassAttr.ORDER: PropClassAttrChange(11, Action.REPLACE, True),
            ...
            PropClassAttr.DATATYPE: PropClassAttrChange(XsdDatatypes.anyURI, Action.CREATE, True),
            PropClassAttr.TO_NODE_IRI: PropClassAttrChange(Xsd_QName('test:comment'), Action.DELETE, True)
        })
        p1.update()
        self.assertEqual(p1.changeset, {})
        ...
        self.assertEqual(p2[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.LANGUAGE_IN],
                         {Language.EN, Language.DE, Language.FR, Language.IT})
        self.assertEqual(p2[PropClassAttr.RESTRICTIONS][PropertyRestrictionType.IN], {"gaga", "is was"})
        self.assertEqual(p2[PropClassAttr.ORDER], 12)
    ...
    def test_propertyclass_delete_attrs(self):
        ...
        p2 = PropertyClass.read(con=self._connection,
                                graph=Xsd_NCName('test'),
                                property_class_iri=Xsd_QName('test:testDelete'))
        self.assertEqual(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.MIN_COUNT), 0)
        self.assertIsNone(p2.get(PropClassAttr.NAME))
        self.assertIsNone(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.MAX_COUNT))
        self.assertIsNone(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.UNIQUE_LANG))
        self.assertIsNone(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.LANGUAGE_IN))
        self.assertIsNone(p2[PropClassAttr.RESTRICTIONS].get(PropertyRestrictionType.IN))
