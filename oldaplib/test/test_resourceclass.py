...
class TestResourceClass(unittest.TestCase):
    ...
    def test_reading_sys(self):
        ...
        self.assertEqual(prop3.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop3.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop3.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop3.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop4.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop4.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop4.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop4.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop5.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop5.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop5.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop5.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop6.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop6.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop6.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop6.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop7.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop7.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop7.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop7.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop8.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop8.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop8.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop8.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop9.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop9.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop9.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop9.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop10.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop10.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop10.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop10.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
        ...
        self.assertEqual(prop11.creator, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop11.created, Xsd_dateTime('2023-11-04T12:00:00+00:00'))
        self.assertEqual(prop11.contributor, Iri('https://orcid.org/0000-0003-1681-4036'))
        self.assertEqual(prop11.modified, Xsd_dateTime('2023-11-04T12:00:00Z'))
